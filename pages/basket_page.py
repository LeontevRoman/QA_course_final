...
class BasketPage(BasePage):
    def sould_not_add_basket(self):
        ...
        assert self.sould_be_empty_basket_message(), 'the basket is not empty'
    ...
    def sould_be_empty_basket_message(self):
        message = self.browser.find_element(*GoToBasket.BASKET_MESSAGE)
        try:
            'Your basket is empty.' in message.text
